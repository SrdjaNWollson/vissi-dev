...
define('OWNER', 'Panda Resort');
define('EMAIL', 'srdjan.nezic@wollson.rs');
define('ADDRESS', 'John Smith 33');
define('PHONE', '+38111932113');
define('MOBILE', '+38164932113');
define('FAX', '');
define('DB_NAME', 'vissi_vissi');
define('DB_HOST', '192.168.0.37');
define('DB_PORT', '3306');
define('DB_USER', 'wollson');
define('DB_PASS', '123');
define('SENDER_EMAIL', '');
define('SENDER_NAME', '');
define('USE_SMTP', '0');
