...
$(document).ready(function(){
    ...
    if($('.royalSlider').length){
        function royalSliderInit(){
            ...
            if($('.royalSlider').hasClass('thumbs')){
                console.log(true);
                sliderArray['controlNavigation'] = 'thumbnails';
                sliderArray['thumbs'] = {orientation:'horizontal',arrows:true,fitInViewport:true};
            }
            setTimeout(function(){
                $('.royalSlider').royalSlider(sliderArray);
            }, 400);
        }
        royalSliderInit();
        $(window).resize(function(){
