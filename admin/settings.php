...
$password = '';
if(isset($_SESSION['user']['id'])) @add_defaultAppearance($db);
//var_dump($_POST['edit_settings']);
...
if($action == 'edit_settings'){
    ...
    $header_sticky = $_POST['header_sticky'];
    $menu_position = $_POST['menu_position'];
    $logo_position = $_POST['logo_position'];
    $arrow_position = $_POST['arrow_position'];
    $booking_search_position = $_POST['booking_search_position'];
    $footer_columns = $_POST['footer_columns'];
    ...
    if(check_token('/'.ADMIN_FOLDER.'/settings.php', 'settings', 'post')){
        ...
        if(count($field_notice) == 0){
            ...
            if($db !== false){
                ...
                $data['header_sticky'] = $header_sticky;
                $data['menu_position'] = $menu_position;
                $data['logo_position'] = $logo_position;
                $data['arrow_position'] = $arrow_position;
                $data['booking_search_position'] = $booking_search_position;
                $data['footer_columns'] = $footer_columns;

                $where = " WHERE user_id = " . $_SESSION['user']['id'];

                @$result_appearance = db_prepareUpdate($db, 'pm_appearance', $data, $where)->execute();
...
$appearance = db_selectWhere($db,'appearance',' WHERE user_id = ' . $_SESSION['user']['id'])->fetch(PDO::FETCH_ASSOC);
                    ...
                    <div class="panel panel-default">
                        <ul class="nav nav-tabs pt5">
                            ...
                            if($_SESSION['user']['type'] == 'administrator'){ ?>
                                ...
                                <li><a data-toggle="tab" href="#appearance"><i class="fas fa-fw fa-adjust"></i> <?php echo $texts['APPEARANCE']; ?></a></li>
                                <?php
                            } ?>
                        </ul>
                        <div class="panel-body">
                            <div class="tab-content">
                                ...
                                if($_SESSION['user']['type'] == 'administrator'){ ?>
                                    ...
                                    <div id="appearance" class="tab-pane fade<?php if($_SESSION['user']['type'] != 'administrator') echo ' in active'; ?>">
                                    	<div class="col-md-8" id="appearance-header">
                                        	<h3>Header</h3>
	                                        <div class="row mb10">
	                                             <div class="col-md-8">
	                                                <div class="row">
	                                                    <label class="col-md-3 control-label">
	                                                        <?php echo $texts['HEADER_TYPE']; ?> <span class="red">*</span>
	                                                    </label>
	                                                    <div class="col-md-8">
	                                                        <div class="form-inline">
	                                                            <label class="radio-inline">
	                                                                <input type="radio" name="header_type" value="1"<?php if($appearance['header_type'] == '1') echo ' checked="checked"'; ?>> <?php echo $texts['CLASSIC']; ?><br>
	                                                            </label>
	                                                            <label class="radio-inline">
	                                                                <input type="radio" name="header_type" value="2"<?php if($appearance['header_type'] == '2') echo ' checked="checked"'; ?>> <?php echo $texts['FULL_SCREEN']; ?>
	                                                            </label>
	                                                            <div class="field-notice" rel="header_type"></div>
	                                                        </div> 
	                                                    </div>
	                                                </div>
	                                            </div>
	                                        ...
	                                        <div class="row mb10">
	                                             <div class="col-md-8">
	                                                <div class="row">
	                                                    <label class="col-md-3 control-label">
	                                                        <?php echo $texts['STICKY']; ?> <span class="red">*</span>
	                                                    </label>
	                                                    <div class="col-md-8">
	                                                        <div class="form-inline">
	                                                            <label class="radio-inline">
	                                                                <input type="radio" name="header_sticky" value="1"<?php if($appearance['header_sticky'] == '1') echo ' checked="checked"'; ?>> <?php echo $texts['YES_OPTION']; ?><br>
	                                                            </label>
	                                                            <label class="radio-inline">
	                                                                <input type="radio" name="header_sticky" value="2"<?php if($appearance['header_sticky'] == '0') echo ' checked="checked"'; ?>> <?php echo $texts['NO_OPTION']; ?>
	                                                            </label>
	                                                            <div class="field-notice" rel="header_sticky"></div>
	                                                        </div> 
	                                                    </div>
	                                                </div>
	                                            </div>
	                                        ...
	                                        <div class="row mb10">
	                                             <div class="col-md-8">
	                                                <div class="row">
	                                                    <label class="col-md-3 control-label">
	                                                        <?php echo $texts['MENU_POSITION']; ?> <span class="red">*</span>
	                                                    </label>
	                                                    <div class="col-md-8">
	                                                        <div class="form-inline">
	                                                            <label class="radio-inline">
	                                                                <input type="radio" name="menu_position" value="1"<?php if($appearance['menu_position'] == '1') echo ' checked="checked"'; ?>> <?php echo $texts['LEFT']; ?><br>
	                                                            </label>
	                                                            <label class="radio-inline">
	                                                                <input type="radio" name="menu_position" value="2"<?php if($appearance['menu_position'] == '2') echo ' checked="checked"'; ?>> <?php echo $texts['CENTER']; ?>
	                                                            </label>
	                                                            <label class="radio-inline">
	                                                                <input type="radio" name="menu_position" value="3"<?php if($appearance['menu_position'] == '3') echo ' checked="checked"'; ?>> <?php echo $texts['RIGHT']; ?>
	                                                            </label>
	                                                            <div class="field-notice" rel="menu_position"></div>
	                                                        </div>
	                                                    </div>
	                                                </div>
	                                            </div>
	                                        ...
	                                        <div class="row mb10">
	                                             <div class="col-md-8">
	                                                <div class="row">
	                                                    <label class="col-md-3 control-label">
	                                                        <?php echo $texts['LOGO_POSITION']; ?> <span class="red">*</span>
	                                                    </label>
	                                                    <div class="col-md-8">
	                                                        <div class="form-inline">
	                                                            <label class="radio-inline">
	                                                                <input type="radio" name="logo_position" value="1"<?php if($appearance['logo_position'] == '1') echo ' checked="checked"'; ?>> <?php echo $texts['LEFT']; ?><br>
	                                                            </label>
	                                                            <label class="radio-inline">
	                                                                <input type="radio" name="logo_position" value="2"<?php if($appearance['logo_position'] == '2') echo ' checked="checked"'; ?>> <?php echo $texts['TOP']; ?>
	                                                            </label>
	                                                            <label class="radio-inline">
	                                                                <input type="radio" name="logo_position" value="3"<?php if($appearance['logo_position'] == '3') echo ' checked="checked"'; ?>> <?php echo $texts['CENTER']; ?>
	                                                            </label>
	                                                            <label class="radio-inline">
	                                                                <input type="radio" name="logo_position" value="4"<?php if($appearance['logo_position'] == '4') echo ' checked="checked"'; ?>> <?php echo $texts['BOTTOM']; ?>
	                                                            </label>
	                                                            <label class="radio-inline">
	                                                                <input type="radio" name="logo_position" value="5"<?php if($appearance['logo_position'] == '5') echo ' checked="checked"'; ?>> <?php echo $texts['RIGHT']; ?>
	                                                            </label>
	                                                            <div class="field-notice" rel="logo_position"></div>
	                                                        </div>
	                                                    </div>
	                                                </div>
	                                            </div>
                                        ...
                                        <div class="col-md-8" id="appearance-slider">
                                            <h3>Slider</h3>
                                            <div class="row mb10">
                                                 <div class="col-md-8">
                                                    <div class="row">
                                                        <label class="col-md-3 control-label">
                                                            <?php echo $texts['ARROW_POSITION']; ?> <span class="red">*</span>
                                                        </label>
                                                        <div class="col-md-8">
                                                            <div class="form-inline">
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="arrow_position" value="1"<?php if($appearance['arrow_position'] == '1') echo ' checked="checked"'; ?>> <?php echo $texts['CENTER']; ?><br>
                                                                </label>
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="arrow_position" value="2"<?php if($appearance['arrow_position'] == '2') echo ' checked="checked"'; ?>> <?php echo $texts['BOTTOM']; ?>
                                                                </label>
                                                                <div class="field-notice" rel="arrow_position"></div> 
                                                            </div> 
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-8" id="appearance-booking">
                                            <h3>Booking</h3>
                                            <div class="row mb10">
                                                 <div class="col-md-8">
                                                    <div class="row">
                                                        <label class="col-md-4 control-label">
                                                            <?php echo $texts['BOOKING_SEARCH_POSITION']; ?> <span class="red">*</span>
                                                        </label>
                                                        <div class="col-md-8">
                                                            <div class="form-inline">
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="booking_search_position" value="1"<?php if($appearance['booking_search_position'] == '1') echo ' checked="checked"'; ?>> <?php echo $texts['TOP']; ?><br>
                                                                </label>
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="booking_search_position" value="2"<?php if($appearance['booking_search_position'] == '2') echo ' checked="checked"'; ?>> <?php echo $texts['BOTTOM']; ?>
                                                                </label>
                                                                <label class="radio-inline">
                                                                    <input type="radio" name="booking_search_position" value="3"<?php if($appearance['booking_search_position'] == '3') echo ' checked="checked"'; ?>> <?php echo $texts['CENTER']; ?>
                                                                </label>
                                                                <div class="field-notice" rel="booking_search_position"></div> 
                                                            </div> 
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-8" id="appearance-footer">
                                            <h3>Footer</h3> 
                                            <div class="row mb10">
                                                 <div class="col-md-8">
                                                    <div class="row">
                                                        <label class="col-md-3 control-label">
                                                            <?php echo $texts['FOOTER_COLUMNS']; ?> <span class="red">*</span>
                                                        </label>
                                                        <div class="col-md-8">
                                                            <div class="form-inline">
                                                                <input class="form-control" type="number" value="<?php echo $appearance['footer_columns']; ?>" name="footer_columns">
                                                                <div class="field-notice" rel="footer_columns"></div> 
                                                            </div> 
                                                        </div>
                                                    </div>
                                                </div>
