...
--
-- Host: localhost
-- Generation Time: Aug 02, 2018 at 08:25 AM
...
(4, 1, 'Première gallery', '', 'premiere-gallery', '', '', '1', 7, '1', 0, 1, 2, 1524062141, 1524818766, NULL, NULL, 0, 0),
(4, 2, 'First gallery', '', 'first-gallery', '', '', '1', 7, '1', 0, 1, 2, 1524062141, 1524818766, NULL, NULL, 0, 0),
(4, 3, 'First gallery', '', 'first-gallery', '', '', '1', 7, '1', 0, 1, 2, 1524062141, 1524818766, NULL, NULL, 0, 0),
(5, 1, 'Amazing posts', '', 'amazing-posts', '', '', '1', 7, '1', 0, 1, 3, 1524062141, 1527684501, NULL, NULL, 0, 0),
(5, 2, 'Amazing posts', '', 'amazing-posts', '', '', '1', 7, '1', 0, 1, 3, 1524062141, 1527684501, NULL, NULL, 0, 0),
(5, 3, 'Amazing posts', '', 'amazing-posts', '', '', '1', 7, '1', 0, 1, 3, 1524062141, 1527684501, NULL, NULL, 0, 0),
...
(8, 1, '', '', '', '', '', '2', 1, '1', 1, 1, 5, 1530708609, 1530708711, 1530708060, NULL, 0, NULL),
(8, 2, 'Martin Sorelli', 'London, UK', 'martin-sorelli', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc dui ante, commodo in pulvinar vitae, pellentesque in elit. Suspendisse ultrices, tortor a ornare volutpat, tortor tortor commodo justo, nec elementum ipsum lacus ac odio. Cras vel nisl ac mauris varius interdum vitae vel risus. Curabitur ornare convallis ipsum, quis consequat odio blandit eu. Nunc magna lorem, blandit id nisi non, ultricies convallis leo. Nulla libero lorem, dignissim quis urna id, ultricies hendrerit erat. Sed ex lacus, varius ac volutpat sit amet, tincidunt at odio. Proin a ipsum quis enim ultricies interdum quis at augue. Cras pharetra enim vel volutpat blandit. Fusce venenatis est in nibh interdum, auctor faucibus ligula viverra. Nam molestie iaculis arcu, nec sollicitudin massa tincidunt porttitor.</p>\r\n', '', '2', 1, '1', 1, 1, 5, 1530708609, 1530708711, 1530708060, NULL, 0, NULL),
(8, 3, '', '', '', '', '', '2', 1, '1', 1, 1, 5, 1530708609, 1530708711, 1530708060, NULL, 0, NULL),
(9, 1, '', '', '', '', '', '2', 1, '1', 1, 1, 5, 1530708609, 1530708847, 1530708060, NULL, 0, NULL),
(9, 2, 'Marko Marković', 'Belgrade, Serbia', 'marko-markovic', '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc dui ante, commodo in pulvinar vitae, pellentesque in elit. Suspendisse ultrices, tortor a ornare volutpat, tortor tortor commodo justo, nec elementum ipsum lacus ac odio. Cras vel nisl ac mauris varius interdum vitae vel risus. Curabitur ornare convallis ipsum, quis consequat odio blandit eu. Nunc magna lorem, blandit id nisi non, ultricies convallis leo. Nulla libero lorem, dignissim quis urna id, ultricies hendrerit erat. Sed ex lacus, varius ac volutpat sit amet, tincidunt at odio. Proin a ipsum quis enim ultricies interdum quis at augue. Cras pharetra enim vel volutpat blandit. Fusce venenatis est in nibh interdum, auctor faucibus ligula viverra. Nam molestie iaculis arcu, nec sollicitudin massa tincidunt porttitor.</p>\r\n', '', '2', 1, '1', 1, 1, 5, 1530708609, 1530708847, 1530708060, NULL, 0, NULL),
(9, 3, '', '', '', '', '', '2', 1, '1', 1, 1, 5, 1530708609, 1530708847, 1530708060, NULL, 0, NULL);
...
(39, 1, 5, NULL, 1, 13, 'mk-paket-single-oseti-prirodui.jpg', NULL, 'image'),
(39, 2, 5, NULL, 1, 13, 'mk-paket-single-oseti-prirodui.jpg', NULL, 'image'),
(39, 3, 5, NULL, 1, 13, 'mk-paket-single-oseti-prirodui.jpg', NULL, 'image'),
...
(2, 1, 'Contact', 'Contact', NULL, 'page', 2, NULL, 1, 1, 1, 7),
(2, 2, 'Contact', 'Contact', NULL, 'page', 2, NULL, 1, 1, 1, 7),
(2, 3, 'جهة الاتصال', 'جهة الاتصال', NULL, 'page', 2, NULL, 1, 1, 1, 7),
...
(16, 1, 'Activités', 'Activités', NULL, 'page', 16, '', 1, 0, 1, 3),
(16, 2, 'Conferences & Events', 'Activities', NULL, 'page', 16, '', 1, 0, 1, 3),
(16, 3, 'Activities', 'Activities', NULL, 'page', 16, '', 1, 0, 1, 3),
...
(19, 1, 'Your beach', 'Your beach', NULL, 'page', 20, '', 1, 0, 1, 5),
(19, 2, 'Your beach', 'Your beach', NULL, 'page', 20, '', 1, 0, 1, 5),
(19, 3, 'Your beach', 'Your beach', NULL, 'page', 20, '', 1, 0, 1, 5),
(20, 1, 'About Us', 'About Us', NULL, 'page', 19, '', 1, 0, 1, 6),
(20, 2, 'About Us', 'About Us', NULL, 'page', 19, '', 1, 0, 1, 6),
...
(1, 1, 'Accueil', 'Lorem ipsum dolor sit amet', 'Consectetur adipiscing elit', 'Accueil', '', '', 'index,follow', '', '', '<p>[show_boxes col=\"3\" items=\"3\" table=\"pm_room\"]</p>\r\n', NULL, 'home', '', 1, 1, 1, 1524062141, 1530714757, 0, 0, 0),
(1, 2, 'Home', 'Panda Resort, Luxury Hotel', '', 'Panda Resort, web software to create and manage hotels websites', '', '', 'index,follow', '', '', '', NULL, 'home', '', 1, 1, 1, 1524062141, 1530714757, 0, 0, 0),
...
(7, 1, 'Galerie', 'Galerie', '', 'Galerie', 'galerie', '', 'index,follow', '', '', '', NULL, 'page', 'gallery', 0, 1, 4, 1524062141, 1524062141, 0, 0, 0),
(7, 2, 'Gallery', 'Gallery', '', 'Gallery', 'gallery', '', 'index,follow', '', '', '', NULL, 'page', 'gallery', 0, 1, 4, 1524062141, 1524062141, 0, 0, 0),
(7, 3, 'صور معرض', 'صور معرض', '', 'صور معرض', 'gallery', '', 'index,follow', '', '', '', NULL, 'page', 'gallery', 0, 1, 4, 1524062141, 1524062141, 0, 0, 0),
...
(9, 1, 'Chambres', 'Chambres', '', 'Chambres', 'chambres', '', 'index,follow', '', '', '', NULL, 'rooms', 'room', 0, 1, 3, 1524062141, 1524062141, 0, 0, 0),
(9, 2, 'Rooms', 'Rooms', '', 'Rooms', 'rooms', '', 'index,follow', '', '', '', NULL, 'rooms', 'room', 0, 1, 3, 1524062141, 1524062141, 0, 0, 0),
(9, 3, 'الغرف', 'الغرف', '', 'الغرف', 'rooms', '', 'index,follow', '', '', '', NULL, 'rooms', 'room', 0, 1, 3, 1524062141, 1524062141, 0, 0, 0),
...
(18, 1, 'Special Offers', 'Special Offers', '', 'special-offers', '', '', '', NULL, '', '', NULL, 'offer', 'offer', 0, 1, 18, 1530613153, 1530704229, 0, NULL, NULL),
(18, 2, 'Special Offers', 'Special Offers', '', 'special-offers', '', '', '', NULL, '', '', NULL, 'offer', 'offer', 0, 1, 18, 1530613153, 1530704229, 0, NULL, NULL),
(18, 3, 'Special Offers', 'Special Offers', '', 'special-offers', '', '', '', NULL, '', '', NULL, 'offer', 'offer', 0, 1, 18, 1530613153, 1530704229, 0, NULL, NULL),
(19, 1, 'About us', 'About us', '', 'about-us', '', '', '', NULL, '', '', NULL, 'page', '', 0, 1, 19, 1530618260, 1530618260, 0, NULL, NULL),
(19, 2, 'About us', 'About us', '', 'about-us', '', '', '', NULL, '', '', NULL, 'page', '', 0, 1, 19, 1530618260, 1530618260, 0, NULL, NULL),
(19, 3, 'About us', 'About us', '', 'about-us', '', '', '', NULL, '', '', NULL, 'page', '', 0, 1, 19, 1530618260, 1530618260, 0, NULL, NULL),
(20, 1, 'Your beach', 'Your beach', '', 'your-beach', '', '', '', NULL, '', '', NULL, 'page', '', 0, 1, 20, 1530618294, 1530618294, 0, NULL, NULL),
(20, 2, 'Your beach', 'Your beach', '', 'your-beach', '', '', '', NULL, '', '', NULL, 'page', '', 0, 1, 20, 1530618294, 1530618294, 0, NULL, NULL),
(20, 3, 'Your beach', 'Your beach', '', 'your-beach', '', '', '', NULL, '', '', NULL, 'page', '', 0, 1, 20, 1530618294, 1530618294, 0, NULL, NULL);
...
CREATE TABLE `pm_slide` (
  ...
  `checked` int(11) DEFAULT '0',
  `rank` int(11) DEFAULT '0',
  `id_slider` int(11) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 1, '', '', 1, 1, 1, 1),
(1, 2, '<h1>ENJOY THE SUNSET</h1>\r\n\r\n<h2>12 days with Beach excursion</h2>\r\n', '', 1, 1, 1, 1),
(1, 3, '', '', 1, 1, 1, 1),
(2, 1, '', '', 1, 1, 2, 1),
...
(1, 'Administrator', '', 'srdjan.nezic@wollson.rs', 'Srdjan', '9de2a46a484f0ef5a6ae059e39ee2fa9', 'administrator', 1524062141, 1524062141, 1, '', '', '', '', '', '', '', '', '');
...
--
-- Indexes for table `pm_appearance`
--
ALTER TABLE `pm_appearance`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_AppearanceUser` (`user_id`);
...
ALTER TABLE `pm_offer`
  ADD PRIMARY KEY (`id`,`lang`),
  ADD KEY `offer_lang_fkey` (`lang`) USING BTREE;
...
--
-- Indexes for table `pm_package_file`
--
ALTER TABLE `pm_package_file`
  ADD PRIMARY KEY (`id`,`lang`),
  ADD KEY `room_file_fkey` (`id_item`,`lang`),
  ADD KEY `room_file_lang_fkey` (`lang`);
...
ALTER TABLE `pm_slide`
  ...
  ADD KEY `FK_SlideSlider` (`id_slider`);
...
--
-- Indexes for table `pm_slider`
--
ALTER TABLE `pm_slider`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `pm_activity_session_hour`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pm_appearance`
--
ALTER TABLE `pm_appearance`
...
--
-- AUTO_INCREMENT for table `pm_package_file`
--
ALTER TABLE `pm_package_file`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `pm_slide_file`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `pm_slider`
--
ALTER TABLE `pm_slider`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
